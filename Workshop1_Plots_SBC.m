...
% % % uncertainty = 0;
% % % 
% % % x_1 = 1*M_slope*t_vec + C_intercept + uncertainty*rand(size(t_vec));
% % % x_2 = 2*M_slope*t_vec + C_intercept + uncertainty*rand(size(t_vec));
% % % x_3 = 3*M_slope*t_vec + C_intercept + uncertainty*rand(size(t_vec));
% % % x_4 = 4*M_slope*t_vec + C_intercept + uncertainty*rand(size(t_vec));
% % % x_5 = 5*M_slope*t_vec + C_intercept + uncertainty*rand(size(t_vec));
